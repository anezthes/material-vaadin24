 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Fe,Be,ze,He;const C=window,f=i=>{C.emitLitDebugLogEvents&&C.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))};let _n=0,$e;(Fe=C.litIssuedWarnings)!==null&&Fe!==void 0||(C.litIssuedWarnings=new Set),$e=(i,e)=>{e+=i?` See https://lit.dev/msg/${i} for more information.`:"",C.litIssuedWarnings.has(e)||(console.warn(e),C.litIssuedWarnings.add(e))},$e("dev-mode","Lit is in dev mode. Not recommended for production!");const $=!((Be=C.ShadyDOM)===null||Be===void 0)&&Be.inUse&&((ze=C.ShadyDOM)===null||ze===void 0?void 0:ze.noPatch)===!0?C.ShadyDOM.wrap:i=>i,K=C.trustedTypes,Dt=K?K.createPolicy("lit-html",{createHTML:i=>i}):void 0,yn=i=>i,Ne=(i,e,t)=>yn,bn=i=>{if(z!==Ne)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");z=i},wn=()=>{z=Ne},rt=(i,e,t)=>z(i,e,t),st="$lit$",O=`lit$${String(Math.random()).slice(9)}$`,hi="?"+O,Sn=`<${hi}>`,oe=document,re=(i="")=>oe.createComment(i),se=i=>i===null||typeof i!="object"&&typeof i!="function",ui=Array.isArray,En=i=>ui(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",We=`[ 	
\f\r]`,Cn=`[^ 	
\f\r"'\`<>=]`,Tn=`[^\\s"'>=/]`,Z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Vt=1,je=2,$n=3,Mt=/-->/g,Ut=/>/g,U=new RegExp(`>|${We}(?:(${Tn}+)(${We}*=${We}*(?:${Cn}|("|')|))|$)`,"g"),xn=0,Ft=1,Rn=2,Bt=3,Ge=/'/g,qe=/"/g,pi=/^(?:script|style|textarea|title)$/i,Nn=1,xe=2,ct=1,Re=2,kn=3,An=4,Ln=5,ht=6,In=7,fi=i=>(e,...t)=>(e.some(n=>n===void 0)&&console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`),{_$litType$:i,strings:e,values:t}),E=fi(Nn),uo=fi(xe),B=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),zt=new WeakMap,q=oe.createTreeWalker(oe,129,null,!1);let z=Ne;const Pn=(i,e)=>{const t=i.length-1,n=[];let o=e===xe?"<svg>":"",r,s=Z;for(let a=0;a<t;a++){const d=i[a];let c=-1,u,h=0,p;for(;h<d.length&&(s.lastIndex=h,p=s.exec(d),p!==null);)if(h=s.lastIndex,s===Z){if(p[Vt]==="!--")s=Mt;else if(p[Vt]!==void 0)s=Ut;else if(p[je]!==void 0)pi.test(p[je])&&(r=new RegExp(`</${p[je]}`,"g")),s=U;else if(p[$n]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else s===U?p[xn]===">"?(s=r??Z,c=-1):p[Ft]===void 0?c=-2:(c=s.lastIndex-p[Rn].length,u=p[Ft],s=p[Bt]===void 0?U:p[Bt]==='"'?qe:Ge):s===qe||s===Ge?s=U:s===Mt||s===Ut?s=Z:(s=U,r=void 0);console.assert(c===-1||s===U||s===Ge||s===qe,"unexpected parse state B");const W=s===U&&i[a+1].startsWith("/>")?" ":"";o+=s===Z?d+Sn:c>=0?(n.push(u),d.slice(0,c)+st+d.slice(c)+O+W):d+O+(c===-2?(n.push(void 0),a):W)}const l=o+(i[t]||"<?>")+(e===xe?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Q(i){return _({...i,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,g=class extends H{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus="unavailable",this.javaStatus="unavailable",this.tabs=[{id:"log",title:"Log",render:this.renderLog,activate:this.activateLog},{id:"info",title:"Info",render:this.renderInfo},{id:"features",title:"Feature Flags",render:this.renderFeatures}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:this.renderCode})}static get styles(){return[x`
    ...
    `}render(){return E` <div
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${()=>{this.componentPickActive=!0,we(()=>import("./component-picker-4484ce45.js"),[],import.meta.url)}}
        >
